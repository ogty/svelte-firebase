                        ...
                        <div class="bg-grey-lighter h-auto flex flex-col">
                            <div class="container max-w-sm mx-auto flex-1 flex flex-col items-center justify-center px-2">
                                <div class="bg-white px-6 py-8 rounded shadow-md text-black w-full">
                                    ...
                                    <div id="google_button" class="border-4 border-zinc-600 py-3 rounded-lg">
                                        ...
                                        <a href="#" style="margin-left: 10px;" on:click={loginWithGoogle}>
                                    ...
                                    <input value={password} type="password" class="block border border-grey-light w-full p-3 rounded mb-4" name="confirm_password" placeholder="Confirm Password" />
                                    <button type="submit" class="w-full text-center py-3 rounded-lg bg-zinc-900 text-white hover:bg-green-dark focus:outline-none my-1">Create Account</button>
